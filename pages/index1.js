...
export default function Home() {
  return (
    ...
    <div >
                    <h1 role="heading" tabindex="0" class="text-6xl font-bold 2xl:leading-10 leading-0 text-center text-cyan-800">Mosaiquismo y Artesanias</h1>
                    <h2 role="contentinfo" tabindex="0" class="text-base leading-normal text-center text-gray-600 mt-5">Escoge elementos a alegren tu espacio el arte es vida </h2>
                </div>
                <div class="2xl:px-20 lg:px-12 px-4 flex flex-wrap items-start mt-4">
                    <div class="mt-24">
                        <div class="flex items-end shadow-md duration-200 hover:scale-105 hover:shadow-xl">
                            <img tabindex="0" src="mosa3.jpeg" alt="girl with blue background" class="w-20 h-20 rounded-lg mr-6" />
                            <img tabindex="0" src="mosa4.jpeg" alt="guy winking" class="w-48 h-36 rounded-lg" />
                        </div> 
                        <div class="flex items-center justify-end my-6 shadow-md duration-200 hover:scale-105 hover:shadow-xl">
                            <img tabindex="0" src="mosa1.jpeg" alt="guy smiling" />
                        </div>
                        <div class="flex items-start shadow-md duration-200 hover:scale-105 hover:shadow-xl">
                            <img tabindex="0" src="mosa.jpeg" alt="girl with bluw background" class="w-48 h-48 rounded-lg" />
                            <img tabindex="0" src="mosa3.jpeg" alt="guy with glasses" class="w-20 h-20 rounded-lg ml-6 flex-shrink-0 object-cover object-fit" />
                        </div>
                    </div>
                    <div class="ml-6 mt-32 shadow-md duration-200 hover:scale-105 hover:shadow-xl">
                        <img tabindex="0" src="mosa5.jpeg" class="w-72 h-80 rounded-lg" alt="guy with sunglasses" />
                        <div class="flex items-start mt-6">
                            <img tabindex="0" src="mosa6.jpeg" alt="girl  laughing" class="w-80 h-80 rounded-lg" />
                           
                        </div>
                    </div>
                    <div class="mt-14 ml-6">
                        <div class="lg:flex shadow-md duration-200 hover:scale-105 hover:shadow-xl">
                            <div>
