...
<button type="button"  className=""></button>
    ...
    <div className="bg-cover rounded-full shadow-lg shadow-yellow-500/50 sticky top-0 h-screen flex flex-col items-center justify-center bg-fondopaq1 duration-200 ">
        <h2 className="mb-32 text-7xl font-extrabold font-bold text-yellow-500 dark:text-white">Encuentra</h2>
        
    </div>
    <div className="sticky  top-0 rounded-full shadow-lg shadow-yellow-500/50 h-screen flex flex-col items-center justify-center bg-fondona text-white ">
        <h2 className="mb-4 text-7xl font-extrabold font-bold text-white  dark:text-white">los Articulos</h2>
    
    </div>
    <div className="bg-center rounded-full shadow-lg shadow-yellow-500/50  sticky top-0 h-screen flex flex-col items-center justify-center bg-fondon text-gray-200 ">
        <h2 className="mb-4 text-7xl font-extrabold font-bold text-yellow-500 dark:text-white">que crean </h2>
   
    </div>
    <div className="bg-cover rounded-full shadow-lg shadow-yellow-500/50  sticky top-0 h-screen flex flex-col items-center justify-center bg-fondopaq text-gray-500 ">
...
<footer className="text-gray-700 body-font bg-yellow-50">
    <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
      <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
        ...
        <img src="logo2.png" className="mr-4 h-8 sm:h-20"  />
          <span className="ml-3 text-xl text-white">DEV</span>
        </a>
        <p className="mt-2 text-sm text-gray-600">Creaciones unicas para espacios interiores o exteriores</p>
      </div>
