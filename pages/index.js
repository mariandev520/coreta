       ...
       <section  class="bg-white bg-fondo1">
           <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
               <div class="mr-auto place-self-center lg:col-span-7">
                   <h1 class="max-w-2xl mb-4 text-4xl font-extrabold leading-none md:text-5xl xl:text-6xl dark:text-yellow-700">Objetos Artisticos en Tu Hogar</h1>
                   <p class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">From checkout to global sales tax compliance, companies around the world use Flowbite to simplify their payment stack.</p>
                   <a href="#" class="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-white rounded-lg bg-green-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
                       Ingresar al Market
               ...
               <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
                   <img class="max-w-sm overflow-hidden rounded-xl bg-white shadow-md duration-200 hover:scale-105 hover:shadow-xl" src="corina.jpg" alt="mockup"/>
               </div>                
           </div>
   
   
           <div class="py-8 lg:py-16 mx-auto max-w-screen-xl px-4">
               <h2 class="mb-8 lg:mb-8 text-2xl  tracking-tight leading-tight text-center text-gray-900 dark:text-green-700 md:text-4xl"></h2>
  ...
  <div class="pt-16 pb-80 sm:pt-24 sm:pb-40 lg:pt-40 lg:pb-48">
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 sm:static">
      <div class="sm:max-w-lg">
        <h1 class="text-4xl font font-bold tracking-tight text-gray-900 sm:text-6xl">Summer styles are finally here</h1>
...
<footer class="text-gray-700 body-font bg-yellow-50">
