...
<div class="pt-6">
  <nav aria-label="Breadcrumb">
    <ol role="list" class="max-w-2xl mx-auto px-4 flex items-center space-x-2 sm:px-6 lg:max-w-7xl lg:px-8">
      ...
      <li class="text-sm">
        <a href="#" aria-current="page" class="font-medium text-gray-500 hover:text-gray-600"> Posapavas</a>
      </li>
    </ol>
  </nav>
  ...
  <div class=" mt-6 max-w-2xl mx-auto sm:px-6 lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-3 lg:gap-x-8">
    <div class="flex items-end shadow-md duration-200 hover:scale-105 hover:shadow-xl hidden aspect-w-3 aspect-h-4 rounded-lg overflow-hidden lg:block">
      <img src="/posa1/mat2.jpeg" alt="Two each of gray, white, and black shirts laying flat." class="w-full h-full object-center object-cover"/>
    </div>
    
    <div class="hidden lg:grid lg:grid-cols-1 lg:gap-y-8">
      <div class="flex items-end shadow-md duration-200 hover:scale-125 hover:shadow-xl aspect-w-3 aspect-h-2 rounded-lg overflow-hidden">
        <img src="/posa1/mat3.jpeg" alt="Model wearing plain black basic tee." class="w-full h-full object-center object-cover"/>
      </div>
      <div class="flex items-end shadow-md duration-200 hover:scale-125 hover:shadow-xl aspect-w-3 aspect-h-2 rounded-lg overflow-hidden">
        <img src="/posa1/mat4.jpeg" alt="Model wearing plain gray basic tee." class="w-full h-full object-center object-cover"/>
      </div>
    </div>
    <div class="  aspect-w-4 aspect-h-5 sm:rounded-lg sm:overflow-hidden lg:aspect-w-6 lg:aspect-h-4">
      <img src="/posa1/mat0.jpeg" alt="Model wearing plain white basic tee." class=" object-center object-cover"/>
    </div>
  </div>
  ...
  <div class="max-w-2xl mx-auto pt-10 pb-16 px-4 sm:px-6 lg:max-w-7xl lg:pt-16 lg:pb-24 lg:px-8 lg:grid lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8">
    ...
    <div class="mt-4 lg:mt-0 lg:row-span-3">
      ...
      <p class="tracking-tight text-3xl text-gray-900">$3500</p>
