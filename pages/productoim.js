export default function productoim() {
    return (
...
<div className="pt-6">
    ...
    <ol role="list" className="max-w-2xl mx-auto px-4 flex items-center space-x-2 sm:px-6 lg:max-w-7xl lg:px-8">
      <li>
        <div className="flex items-center">
          ...
          <svg width="16" height="20" viewBox="0 0 16 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" classNameName="w-4 h-5 text-gray-300">
      ...
      <li className="text-sm">
        <a href="#" aria-current="page" className="font-medium text-gray-500 hover:text-gray-600"> Espejos</a>
      </li>
    </ol>
  </nav>
  ...
  <div className="mt-6 max-w-2xl mx-auto sm:px-6 lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-3 lg:gap-x-8">
    <div className="hidden aspect-w-3 aspect-h-4 rounded-lg overflow-hidden lg:block">
      <img src="espe1/image1.jpeg" alt="Two each of gray, white, and black shirts laying flat." className="w-full h-full object-center object-cover"/>
    </div>
    
    <div className="hidden lg:grid lg:grid-cols-1 lg:gap-y-8">
      <div className="aspect-w-3 aspect-h-2 rounded-lg overflow-hidden">
        <img src="espe1/image3.jpeg" alt="Model wearing plain black basic tee." className="w-full h-full object-center object-cover"></img>
      </div>
      <div className="aspect-w-3 aspect-h-2 rounded-lg overflow-hidden">
        <img src="espe1/image4.jpeg" alt="Model wearing plain gray basic tee." className="w-full h-full object-center object-cover"></img>
      </div>
    </div>
    <div className="aspect-w-4 aspect-h-5 sm:rounded-lg sm:overflow-hidden lg:aspect-w-6 lg:aspect-h-4">
      <img src="espe1/image7.jpg" alt="Model wearing plain white basic tee." className=" object-center object-cover"></img>
    </div>
  </div>
