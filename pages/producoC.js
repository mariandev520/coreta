...
export default function productesC() {
    return (
...
<div className="pt-6">
    ...
    <ol role="list" className="max-w-2xl mx-auto px-4 flex items-center space-x-2 sm:px-6 lg:max-w-7xl lg:px-8">
      <li>
        <div className="flex items-center">
          <a href="child" className="mr-2 text-sm font-medium text-gray-900"> Volver </a>
  ...
  <div className="mt-6 max-w-2xl mx-auto sm:px-6 lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-3 lg:gap-x-8">
    <div className="hidden aspect-w-3 aspect-h-4 rounded-lg overflow-hidden lg:block">
      <img src="espe3/image.jpeg" alt="Two each of gray, white, and black shirts laying flat." className="w-full h-full object-center object-cover"/>
    </div>
    
    <div className="hidden lg:grid lg:grid-cols-1 lg:gap-y-8">
      <div className="aspect-w-3 aspect-h-2 rounded-lg overflow-hidden">
        <img src="espe3/image1.jpeg" alt="Model wearing plain black basic tee." className="w-full h-full object-center object-cover"/>
      </div>
      <div className="aspect-w-3 aspect-h-2 rounded-lg overflow-hidden">
        <img src="espe3/image2.jpeg" alt="Model wearing plain gray basic tee." className="w-full h-full object-center object-cover"/>
      </div>
    </div>
    <div className="aspect-w-4 aspect-h-5 sm:rounded-lg sm:overflow-hidden lg:aspect-w-6 lg:aspect-h-4">
      <img src="espe3/image4.jpeg" alt="Model wearing plain white basic tee." className=" object-center object-cover"/>
    </div>
  </div>
  ...
  <div className="max-w-2xl mx-auto pt-10 pb-16 px-4 sm:px-6 lg:max-w-7xl lg:pt-16 lg:pb-24 lg:px-8 lg:grid lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8">
    ...
    <div className="mt-4 lg:mt-0 lg:row-span-3">
      ...
      <p className="tracking-tight text-3xl text-gray-900">$11000</p>

      <div className="mt-6">
        <h3 className="sr-only">Caracteristicas</h3>
        <div className="flex items-center">
          <div className="flex items-center">
          ...
          <a href="#" className="ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-500">117 Vistas</a>
        </div>
      </div>
      ...
      <form className="mt-10">
        ...
        <div className="mt-10">
          <div className="flex items-center justify-between">
            ...
            <a href="#" className="text-sm font-medium text-indigo-600 hover:text-indigo-500"></a>
          </div>
          ...
          <fieldset className="mt-4">
            ...
            <div className="grid grid-cols-4 gap-4 sm:grid-cols-8 lg:grid-cols-4">
              ...
              <label className="group relative border rounded-md py-3 px-4 flex items-center justify-center text-sm font-medium uppercase hover:bg-red-500 focus:outline-none sm:flex-1 sm:py-6 bg-white shadow-sm text-gray-900 cursor-pointer">
    ...
    <div className="py-10 lg:pt-6 lg:pb-16 lg:col-start-1 lg:col-span-2 lg:border-r lg:border-gray-200 lg:pr-8">
      ...
      <div>
        ...
        <div className="space-y-6">
          <p className="text-base text-gray-900">Medidas: 45cm Diametro</p>
          <p className="text-base text-gray-900">Color:Blanco chips grises {
      ...
      <div className="mt-10">
        <h3 className="text-sm font-medium text-gray-900">Espacios Adecuados</h3>

        <div className="mt-4">
          <ul role="list" className="pl-4 list-disc text-sm space-y-2">
            <li className="text-gray-400"><span className="text-gray-600">Baño</span></li>

            <li className="text-gray-400"><span className="text-gray-600">Habitacion</span></li>

            <li className="text-gray-400"><span className="text-gray-600">Recibidor</span></li>
