...
<div className="pt-6">
  ...
  <div className="mt-6 max-w-2xl mx-auto sm:px-6 lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-3 lg:gap-x-8">
    <div className="hidden aspect-w-3 aspect-h-4 rounded-lg overflow-hidden lg:block">
      <img src="espe1/espe2a.jpeg" alt="Two each of gray, white, and black shirts laying flat." className="w-full h-full object-center object-cover"/>
    </div>
    
    <div className="hidden lg:grid lg:grid-cols-1 lg:gap-y-8">
      <div className="aspect-w-3 aspect-h-2 rounded-lg overflow-hidden">
        <img src="espe1/espe2b.jpeg" alt="Model wearing plain black basic tee." className="w-full h-full object-center object-cover"/>
      </div>
      <div className="aspect-w-3 aspect-h-2 rounded-lg overflow-hidden">
        <img src="espe1/espe2c.jpeg" alt="Model wearing plain gray basic tee." className="w-full h-full object-center object-cover"/>
      </div>
    </div>
    <div className="aspect-w-4 aspect-h-5 sm:rounded-lg sm:overflow-hidden lg:aspect-w-6 lg:aspect-h-4">
      <img src="espe1/espe2.jpg" alt="Model wearing plain white basic tee." className=" object-center object-cover"/>
    </div>
  </div>
      ...
      <div className="mt-10">
        ...
        <div className="mt-4">
          <ul role="list" className="pl-4 list-disc text-sm space-y-2">
            <li className="text-gray-400"><span className="text-gray-600">Ancho: 40cm </span></li>

            <li className="text-gray-400"><span className="text-gray-600">Alto: 60cm</span></li>

            <li className="text-gray-400"><span className="text-gray-600">Gama arena marron</span></li>

            <li className="text-gray-400"><span className="text-gray-600">Cabañas o quinchos</span></li>
          </ul>
        </div>
      </div>
