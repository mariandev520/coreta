...
<Link href="/">
 <button
   ...
   type="button" 
   class="border border-gray-200 bg-green-400 text-gray-600 rounded-md px-8 py-2 m-2 transition duration-500 ease select-none hover:bg-gray-800 focus:outline-none focus:shadow-outline"
 >
   INICIO
 </button>
 </Link>
